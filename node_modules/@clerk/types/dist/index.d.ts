...
type GetInvoicesParams = WithOptionalOrgType<ClerkPaginationParams>;
type CommerceInvoiceStatus = 'paid' | 'unpaid' | 'past_due';
interface CommerceInvoiceResource extends ClerkResource {
    id: string;
...
interface CommerceInvoiceTotals extends Omit<CommerceCheckoutTotals, 'totalDueNow'> {
}
...
interface CommerceInvoiceJSON extends ClerkResourceJSON {
...
interface CommerceInvoiceTotalsJSON extends Omit<CommerceCheckoutTotalsJSON, 'total_due_now'> {
}
